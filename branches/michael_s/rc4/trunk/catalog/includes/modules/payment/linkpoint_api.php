...
//      mail('emailname@domain.org', time() . 'linkpoint_api.php 136', $HTTP_POST_VARS['linkpoint_api_cc_number'] ."\n" . $HTTP_POST_VARS['linkpoint_api_cc_expires_month'] ."\n" .$HTTP_POST_VARS['linkpoint_api_cc_expires_year']);
