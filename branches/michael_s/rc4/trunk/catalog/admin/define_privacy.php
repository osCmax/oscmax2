<?php
/*
$Id: define_privacy.php 14 2006-07-28 17:42:07Z user $
  ...
  define_privacy.php Version 1.2

  DESCRIPTION:

  An extremely simple hack of define_languages.php, this file
  ALWAYS looks for the file define_privacy.php in the language directory.
...
// This will cause it to look for 'conditions_content.php'
  ...
  $HTTP_GET_VARS['filename'] = DEFINE_PRIVACY_CONTENT;
...
?>
          <tr><?php echo tep_draw_form('language', FILENAME_DEFINE_PRIVACY, 'lngdir=' . $HTTP_GET_VARS['lngdir'] . '&filename=' . $HTTP_GET_VARS['filename'] . '&action=save'); ?>
...
?>
          ...
          <tr>
            <td><?php echo '<a href="' . tep_href_link(FILENAME_DEFINE_PRIVACY, 'lngdir=' . $HTTP_GET_VARS['lngdir']) . '">' . tep_image_button('button_back.gif', IMAGE_BACK) . '</a>'; ?></td>
          </tr>
<?php
    }
  } else {
