...
// Added line for Admin w/access levels
                     ...
                     'children' => array(array('title' => BOX_TOOLS_BACKUP, 'link' => tep_href_link(FILENAME_BACKUP, 'selected_box=tools')),
                                         ...
                                         array('title' => BOX_TOOLS_DEFINE_LANGUAGE, 'link' => tep_href_link(FILENAME_DEFINE_LANGUAGE, 'selected_box=tools')),
      ...
      <tr bgcolor="#000000">
        <td><table border="0" width="600" height="440" cellspacing="0" cellpadding="0">
          <tr bgcolor="#ffffff" height="50">
            <td height="50"><?php echo '<a href="http://www.oscmax.com">' . tep_image(DIR_WS_IMAGES . 'oscmax-logo.png', 'osCMax v2.0 created by AABox Web Hosting', '169', '56') . '</a>'; ?></td>
