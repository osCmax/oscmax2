...
*/
      ...
      echo tep_draw_form('checkout_address', tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', $request_type)) . tep_draw_hidden_field('action', 'process'); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
            ...
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td align="right" width="50%" valign="top"><table border="0" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="main" align="center" valign="top"><?php echo '<b>' . TITLE_SHIPPING_ADDRESS . '</b><br>' . tep_image(DIR_WS_ICONS . 'arrow_south_east.gif'); ?></td>
                    <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td> 
...
?>
              <tr>
                ...
                <td class="main" width="50%" valign="top" align="right"><?php echo '<b>' . TITLE_PLEASE_SELECT . '</b><br>' . tep_image(DIR_WS_ICONS . 'arrow_east_south.gif'); ?></td>
                <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
              </tr>
<?php
...
// MOD: BOF indvship 4.5
        for ($i=0, $n=sizeof($quotes); $i<$n; $i++) {
            ...
            echo '<tr><td>&nbsp;</td><td colspan="2" class="main">' . sprintf(TEXT_INDV_SHIP, $shipping_modules->get_indvcount(), $currencies->format($shipping_modules->get_shiptotal())) . '</td><td>&nbsp;</td></tr>';
			}
        };
// end indvship
      $radio_buttons = 0;
