...
INSERT INTO configuration VALUES (68,'Installed Modules','MODULE_PAYMENT_INSTALLED','cc.php','List of payment module filenames separated by a semi-colon. This is automatically updated. No need to edit. (Example: cc.php;cod.php;paypal.php)','6','0',NULL,now(),NULL,NULL);
...
INSERT INTO configuration VALUES (70,'Installed Modules','MODULE_SHIPPING_INSTALLED','flat.php','List of shipping module filenames separated by a semi-colon. This is automatically updated. No need to edit. (Example: ups.php;flat.php;item.php)','6','0',NULL,now(),NULL,NULL);
...
INSERT INTO configuration VALUES (165,'E-Mail Address','AFFILIATE_EMAIL_ADDRESS','<affiliate@localhost.com>','The E Mail Address for the Affiliate Programm','35','1',NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (166,'Affiliate Pay Per Sale Payment % Rate','AFFILIATE_PERCENT','10.0000','Percentage Rate for the Affiliate Program','35','2',NULL, '2003-07-17 13:48:39',NULL,NULL);
INSERT INTO configuration VALUES (167,'Payment Threshold','AFFILIATE_THRESHOLD','50.00','Payment Threshold for paying affiliates','35','3',NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (168,'Cookie Lifetime','AFFILIATE_COOKIE_LIFETIME','7200','How long does the click count (seconds) if customer comes back','35','4',NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (169,'Billing Time','AFFILIATE_BILLING_TIME','30','Orders billed must be at least \"30\" days old.<br>This is needed if a order is refunded','35','5',NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (170,'Order Min Status','AFFILIATE_PAYMENT_ORDER_MIN_STATUS','3','The status an order must have at least, to be billed','35','6',NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (171,'Pay Affiliates with check','AFFILIATE_USE_CHECK','false','Pay Affiliates with check','35','7',NULL,now(),NULL, 'tep_cfg_select_option(array(\'true\', \'false\'),');
INSERT INTO configuration VALUES (172,'Pay Affiliates with PayPal','AFFILIATE_USE_PAYPAL','true','Pay Affiliates with PayPal','35','8',NULL,now(),NULL, 'tep_cfg_select_option(array(\'true\', \'false\'),');
INSERT INTO configuration VALUES (173,'Pay Affiliates by Bank','AFFILIATE_USE_BANK','false','Pay Affiliates by Bank','35','9',NULL,now(),NULL, 'tep_cfg_select_option(array(\'true\', \'false\'),');
INSERT INTO configuration VALUES (174,'Individual Affiliate Percentage','AFFILATE_INDIVIDUAL_PERCENTAGE','true','Allow per Affiliate provision','35','10',NULL,now(),NULL, 'tep_cfg_select_option(array(\'true\', \'false\'),');
INSERT INTO configuration VALUES (175,'Use Affiliate-tier','AFFILATE_USE_TIER','true','Multilevel Affiliate provisions','35','11',NULL,now(),NULL, 'tep_cfg_select_option(array(\'true\', \'false\'),');
INSERT INTO configuration VALUES (176,'Number of Tierlevels','AFFILIATE_TIER_LEVELS','3','Number of Tierlevels','35','12',NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (177,'Percentage Rate for the Tierlevels','AFFILIATE_TIER_PERCENTAGE','8.00;5.00;1.00','Percent Rates for the tierlevels<br>Example: 8.00;5.00;1.00','35','13',NULL,now(),NULL,NULL);
...
INSERT INTO configuration VALUES (1161,'Sort Order','MODULE_SHIPPING_FLAT_SORT_ORDER','5','Sort order of display.',6,0,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1158,'Shipping Cost','MODULE_SHIPPING_FLAT_COST','5.00','The shipping cost for all orders using this shipping method.',6,0,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1159,'Tax Class','MODULE_SHIPPING_FLAT_TAX_CLASS','0','Use the following tax class on the shipping fee.',6,0,NULL,now(),'tep_get_tax_class_title','tep_cfg_pull_down_tax_classes(');
INSERT INTO configuration VALUES (1160,'Shipping Zone','MODULE_SHIPPING_FLAT_ZONE','0','If a zone is selected,only enable this shipping method for that zone.',6,0,NULL,now(),'tep_get_zone_class_title','tep_cfg_pull_down_zone_classes(');
INSERT INTO configuration VALUES (1157,'Enable Flat Shipping','MODULE_SHIPPING_FLAT_STATUS','True','Do you want to offer flat rate shipping?',6,0,NULL,now(),NULL,'tep_cfg_select_option(array(\'true\', \'false\'),');
...
INSERT INTO configuration VALUES (1391,'Enable PayPal Express Checkout','MODULE_PAYMENT_PAYPAL_EXPRESS_STATUS','False','Do you want to accept PayPal Express Checkout payments?',6,1,NULL,now(),NULL,'tep_cfg_select_option(array(\'true\', \'false\'),');
INSERT INTO configuration VALUES (1390,'cURL Program Location','MODULE_PAYMENT_PAYPAL_DIRECT_CURL','','The location to the cURL program application.',6,0,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1388,'Sort order of display.','MODULE_PAYMENT_PAYPAL_DIRECT_SORT_ORDER','0','Sort order of display. Lowest is displayed first.',6,0,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1389,'Set Order Status','MODULE_PAYMENT_PAYPAL_DIRECT_ORDER_STATUS_ID','0','Set the status of orders made with this payment module to this value.',6,0,NULL,now(),'tep_get_order_status_name','tep_cfg_pull_down_order_statuses(');
INSERT INTO configuration VALUES (1387,'Payment Zone','MODULE_PAYMENT_PAYPAL_DIRECT_ZONE','0','If a zone is selected,only enable this payment method for that zone.',6,2,NULL,now(),'tep_get_zone_class_title','tep_cfg_pull_down_zone_classes(');
INSERT INTO configuration VALUES (1386,'Card Acceptance Page','MODULE_PAYMENT_PAYPAL_DIRECT_CARD_INPUT_PAGE','Confirmation','The location to accept card information. Either on the Checkout Confirmation page or the Checkout Payment page.',6,0,NULL,now(),NULL,'tep_cfg_select_option(array(\'Confirmation\',\'Payment\'),');
INSERT INTO configuration VALUES (1384,'Transaction Server','MODULE_PAYMENT_PAYPAL_DIRECT_TRANSACTION_SERVER','Sandbox','Use the live or testing (sandbox) gateway server to process transactions?',6,0,NULL,now(),NULL,'tep_cfg_select_option(array(\'Live\',\'Sandbox\'),');
INSERT INTO configuration VALUES (1385,'Transaction Method','MODULE_PAYMENT_PAYPAL_DIRECT_TRANSACTION_METHOD','Sale','The processing method to use for each transaction.',6,0,NULL,now(),NULL,'tep_cfg_select_option(array(\'Authorization\',\'Sale\'),');
INSERT INTO configuration VALUES (1382,'API Password','MODULE_PAYMENT_PAYPAL_DIRECT_API_PASSWORD','','The password to use for the PayPal API service.',6,0,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1383,'API Signature','MODULE_PAYMENT_PAYPAL_DIRECT_API_SIGNATURE','','The signature to use for the PayPal API service.',6,0,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1381,'API Username','MODULE_PAYMENT_PAYPAL_DIRECT_API_USERNAME','','The username to use for the PayPal API service.',6,0,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1394,'API Signature','MODULE_PAYMENT_PAYPAL_EXPRESS_API_SIGNATURE','','The signature to use for the PayPal API service',6,0,NULL,now(),NULL,NULL);
...
INSERT INTO configuration VALUES (1393,'API Password','MODULE_PAYMENT_PAYPAL_EXPRESS_API_PASSWORD','','The password to use for the PayPal API service',6,0,NULL,now(),NULL,NULL);
...
INSERT INTO configuration VALUES (1392,'API Username','MODULE_PAYMENT_PAYPAL_EXPRESS_API_USERNAME','','The username to use for the PayPal API service',6,0,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1380,'Enable PayPal Direct','MODULE_PAYMENT_PAYPAL_DIRECT_STATUS','True','Do you want to accept PayPal Direct payments?',6,1,NULL,now(),NULL,'tep_cfg_select_option(array(\'true\', \'false\'),');
INSERT INTO configuration VALUES (1450,'Purchase without account shippingaddress','PURCHASE_WITHOUT_ACCOUNT_SEPARATE_SHIPPING','yes','Do you allow customers without account to create separately shipping address?',5,'11',NULL,now(),NULL,'tep_cfg_select_option(array(\'yes\',\'no\'),');
...
INSERT INTO configuration VALUES (1448,'Set Order Status','MODULE_PAYMENT_CC_ORDER_STATUS_ID','0','Set the status of orders made with this payment module to this value',6,0,NULL,now(),'tep_get_order_status_name','tep_cfg_pull_down_order_statuses(');
INSERT INTO configuration VALUES (1446,'Sort order of display.','MODULE_PAYMENT_CC_SORT_ORDER','0','Sort order of display. Lowest is displayed first.',6,0,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1447,'Payment Zone','MODULE_PAYMENT_CC_ZONE','0','If a zone is selected,only enable this payment method for that zone.',6,2,NULL,now(),'tep_get_zone_class_title','tep_cfg_pull_down_zone_classes(');
INSERT INTO configuration VALUES (1445,'Split Credit Card E-Mail Address','MODULE_PAYMENT_CC_EMAIL','','If an e-mail address is entered,the middle digits of the credit card number will be sent to the e-mail address (the outside digits are stored in the database with the middle digits censored)',6,0,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1444,'Enable Credit Card Module','MODULE_PAYMENT_CC_STATUS','True','Do you want to accept credit card payments?',6,0,NULL,now(),NULL,'tep_cfg_select_option(array(\'true\', \'false\'),');
INSERT INTO configuration VALUES (1395,'Transaction Server','MODULE_PAYMENT_PAYPAL_EXPRESS_TRANSACTION_SERVER','Sandbox','Use the live or testing (sandbox) gateway server to process transactions?',6,0,NULL,now(),NULL,'tep_cfg_select_option(array(\'Live\',\'Sandbox\'),');
INSERT INTO configuration VALUES (1400,'cURL Program Location','MODULE_PAYMENT_PAYPAL_EXPRESS_CURL','','The location to the cURL program application.',6,0,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1398,'Sort order of display.','MODULE_PAYMENT_PAYPAL_EXPRESS_SORT_ORDER','0','Sort order of display. Lowest is displayed first.',6,0,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1399,'Set Order Status','MODULE_PAYMENT_PAYPAL_EXPRESS_ORDER_STATUS_ID','0','Set the status of orders made with this payment module to this value',6,0,NULL,now(),'tep_get_order_status_name','tep_cfg_pull_down_order_statuses(');
INSERT INTO configuration VALUES (1397,'Payment Zone','MODULE_PAYMENT_PAYPAL_EXPRESS_ZONE','0','If a zone is selected,only enable this payment method for that zone.',6,2,NULL,now(),'tep_get_zone_class_title','tep_cfg_pull_down_zone_classes(');
INSERT INTO configuration VALUES (1396,'Transaction Method','MODULE_PAYMENT_PAYPAL_EXPRESS_TRANSACTION_METHOD','Sale','The processing method to use for each transaction.',6,0,NULL,now(),NULL,'tep_cfg_select_option(array(\'Authorization\',\'Sale\'),');
INSERT INTO configuration VALUES (1421,'Google Checkout Module Version','MODULE_PAYMENT_GOOGLECHECKOUT_VERSION','osCMax v1.4.5_CCS','Version of the installed Module',6,0,NULL,now(),NULL,'tep_cfg_select_option(array(\'osCMax v1.4.5_CCS\'),');
INSERT INTO configuration VALUES (1422,'Enable GoogleCheckout Module','MODULE_PAYMENT_GOOGLECHECKOUT_STATUS','False','Accepts payments through Google Checkout on your site',6,3,NULL,now(),NULL,'tep_cfg_select_option(array(\'true\', \'false\'),');
INSERT INTO configuration VALUES (1423,'Select Mode of Operation','MODULE_PAYMENT_GOOGLECHECKOUT_MODE','https://sandbox.google.com/checkout/','Select either the Developer\'s Sandbox or live Production environment<br />Note that different Id/Key pair will be used depending on the environment selected',6,3,NULL,now(),NULL,'tep_cfg_select_option(array(\'https://sandbox.google.com/checkout/\',''https://checkout.google.com/\'),');
INSERT INTO configuration VALUES (1424,'Production Merchant ID','MODULE_PAYMENT_GOOGLECHECKOUT_MERCHANTID','','Your merchant ID is listed on the "Integration" page under the "Settings" tab',6,1,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1425,'Production Merchant Key','MODULE_PAYMENT_GOOGLECHECKOUT_MERCHANTKEY','','Your merchant key is also listed on the "Integration" page under the "Settings" tab',6,2,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1426,'Sandbox Merchant ID','MODULE_PAYMENT_GOOGLECHECKOUT_MERCHANTID_SNDBOX','152381248163249','Your merchant ID is listed on the "Integration" page under the "Settings" tab',6,1,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1427,'Sandbox Merchant Key','MODULE_PAYMENT_GOOGLECHECKOUT_MERCHANTKEY_SNDBOX','H4SOuyQDtasUOJxmYCrIZw','Your merchant key is also listed on the "Integration" page under the "Settings" tab',6,2,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1428,'.htaccess Basic Authentication Mode','MODULE_PAYMENT_GOOGLECHECKOUT_CGI','False','Your site Site in installed with PHP over CGI? <br /> This configuration will <b>disable</b> PHP Basic Authentication that is NOT compatible with CGI used in the responsehandler.php to validate Google Checkout messages.<br />If setted True you MUST config',6,4,NULL,now(),NULL,'tep_cfg_select_option(array(\'False\',\'True\'),');
INSERT INTO configuration VALUES (1429,'Disable Google Checkout for Virtual Goods?','MODULE_PAYMENT_GOOGLECHECKOUT_VIRTUAL_GOODS','False','If this configuration is enabled and there is any virtual good in the cart the Google Checkout button will be shown disabled.',6,4,NULL,now(),NULL,'tep_cfg_select_option(array(\'true\', \'false\'),');
INSERT INTO configuration VALUES (1430,'Allow US PO BOX shipping?','MODULE_PAYMENT_GOOGLECHECKOUT_USPOBOX','False','Allow sending items to US PO Boxes?',6,4,NULL,now(),NULL,'tep_cfg_select_option(array(\'true\', \'false\'),');
INSERT INTO configuration VALUES (1431,'Select Merchant Calculation Mode of Operation','MODULE_PAYMENT_GOOGLECHECKOUT_MC_MODE','https','Merchant calculation URL for Sandbox environment. (Checkout production environemnt always requires HTTPS.)',6,4,NULL,now(),NULL,'tep_cfg_select_option(array(\'http\',\'https\'),');
INSERT INTO configuration VALUES (1432,'Default Values for Real Time Shipping Rates','MODULE_PAYMENT_GOOGLECHECKOUT_SHIPPING','','Default values for real time rates in case the webservice call fails.<br />Set <b>Default Value</b> to <b>0</b> to disable the method <br/><a href="../googlecheckout/shipping_generator/">Shipping Generator</a>',6,0,NULL,now(),NULL,'gc_cfg_select_shipping(array(\'not\'),');
INSERT INTO configuration VALUES (1433,'GoogleCheckout Carrier Calculated Shipping','MODULE_PAYMENT_GOOGLECHECKOUT_CARRIER_CALCULATED_ENABLED','True','Do you want to use GC Carrier calculated shipping? This feature can be mixed with Flat Rate Shipping,but not Merchant Calculated.',6,4,NULL,now(),NULL,'tep_cfg_select_option(array(\'true\', \'false\'),');
INSERT INTO configuration VALUES (1434,'Carrier Calculater Shipping Configuration','MODULE_PAYMENT_GOOGLECHECKOUT_CARRIER_CALCULATED','fedexGrounddomestic_types_CCS:1.00|0|0,fedexHome Deliverydomestic_types_CCS:1.00|0|0,fedexExpress Saverdomestic_types_CCS:1.00|0|0,fedex2Daydomestic_types_CCS:1.00|0|0,fedexStandard Overnightdomestic_types_CCS:1.00|0|0,fedexPriority Overnightdomestic_types_CCS:1.00|0|0,fedexFirst Overnightdomestic_types_CCS:1.00|0|0,upsGrounddomestic_types_CCS:1.00|0|0,ups3 Day Selectdomestic_types_CCS:1.00|0|0,ups2nd Day Airdomestic_types_CCS:1.00|0|0,upsNext Day Air Saverdomestic_types_CCS:1.00|0|0,upsNext Day Airdomestic_types_CCS:1.00|0|0,upsNext Day Air Early AMdomestic_types_CCS:1.00|0|0,uspsMedia Maildomestic_types_CCS:1.00|0|0,uspsParcel Postdomestic_types_CCS:1.00|0|0,uspsExpress Maildomestic_types_CCS:1.00|0|0','Set Default Values,Fix and Variable charge<br />Set <b>Def. Value</b> to <b>0</b> to disable the method',6,5,NULL,now(),NULL,'gc_cfg_select_CCshipping(');
INSERT INTO configuration VALUES (1435,'Rounding Policy Mode','MODULE_PAYMENT_GOOGLECHECKOUT_TAXMODE','HALF_EVEN','This configuration specifies the methodology that will be used to round values to two decimal places. <a href="http://code.google.com/apis/checkout/developer/Google_Checkout_Rounding_Policy.html">More info</a>',6,4,NULL,now(),NULL,'tep_cfg_select_option(array(\'UP\',\'DOWN\',\'CEILING\',\'HALF_UP\',\'HALF_DOWN\',\'HALF_EVEN\'),');
INSERT INTO configuration VALUES (1436,'Rounding Policy Rule','MODULE_PAYMENT_GOOGLECHECKOUT_TAXRULE','PER_LINE','This configuration specifies when rounding rules should be applied to monetary values while Google Checkout is computing an order total.',6,4,NULL,now(),NULL,'tep_cfg_select_option(array(\'PER_LINE\',\'TOTAL\'),');
INSERT INTO configuration VALUES (1437,'Cart Expiration Time (Minutes)','MODULE_PAYMENT_GOOGLECHECKOUT_EXPIRATION','NONE','Set the time in minutes after which the cart will expire. NONE for no-expiration',6,1,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1438,'Also send notifications with OSC','MODULE_PAYMENT_GOOGLECHECKOUT_USE_CART_MESSAGING','False','Do you also want to send notifications to buyers using OSC\'s mailing system?',6,4,NULL,now(),NULL,'tep_cfg_select_option(array(\'true\', \'false\'),');
INSERT INTO configuration VALUES (1439,'Google Analytics Id','MODULE_PAYMENT_GOOGLECHECKOUT_ANALYTICS','NONE','Do you want to integrate the module with Google Analytics? Add your GA Id (UA-XXXXXX-X),NONE to disable. <br/> More info <a href=\'http://code.google.com/apis/checkout/developer/checkout_analytics_integration.html\'>here</a>',6,1,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1440,'3rd Party Tracking','MODULE_PAYMENT_GOOGLECHECKOUT_3RD_PARTY_TRACKING','NONE','Do you want to integrate the module 3rd party tracking? Add the tracker URL,NONE to disable. <br/> More info <a href=\'http://code.google.com/apis/checkout/developer/checkout_pixel_tracking.html\'>here</a>',6,1,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1441,'Google Checkout restricted product categories','MODULE_PAYMENT_GOOGLECHECKOUT_RESTRICTED_CATEGORIES','','Specify the ids separated by commas \','' of the product categories for which the GC button should be disabled.<br />Check <a href="http://checkout.google.com/support/sell/bin/answer.py?answer=46174&topic=8681">Google Policy</a>',6,8,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1442,'Continue shopping URL.','MODULE_PAYMENT_GOOGLECHECKOUT_CONTINUE_URL','checkout_success.php','Specify the page customers will be directed to if they choose to continue shopping after checkout.',6,8,NULL,now(),NULL,NULL);
INSERT INTO configuration VALUES (1443,'Sort order of display.','MODULE_PAYMENT_GOOGLECHECKOUT_SORT_ORDER','5','Sort order of display. Lowest is displayed first.',6,0,NULL,now(),NULL,NULL);
...
INSERT INTO orders_status VALUES ('100003','1','SofortÃ¼berweisung Vorbereitung','0','0');
INSERT INTO orders_status VALUES ('100003','2','SofortÃ¼berweisung Vorbereitung','0','0');
INSERT INTO orders_status VALUES ('100003','3','SofortÃ¼berweisung Vorbereitung','0','0');
